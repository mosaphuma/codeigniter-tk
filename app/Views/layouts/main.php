...
<body class="bg-dark bg-gradient bg-opacity-25">
    ...
    <div class="container">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li><a class="nav-link <?= isset($page_title) && $page_title == 'Users' ? 'active' : '' ?>" href="<?= base_url('Main/users') ?>">Users</a></li>
            <li><a class="nav-link <?= isset($page_title) && $page_title == 'countrys' ? 'active' : '' ?>" href="<?= base_url('Countryctl/countrys') ?>">Country</a></li>
            <li><a class="nav-link <?= isset($page_title) && $page_title == 'staff' ? 'active' : '' ?>" href="<?= base_url('Main/staff') ?>">Staff</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item <?= isset($page_title) && $page_title == 'IT_ISSUE' ? 'active' : '' ?>" href="<?= base_url('I_codectl/i_codef') ?>">I_CODE</a>
            <a class="dropdown-item <?= isset($page_title) && $page_title == 'IT_ISSUEDETAIL' ? 'active' : '' ?>" href="<?= base_url('I_expansectl/i_expansef') ?>">Expanse Detail</a>
            <a class="dropdown-item <?= isset($page_title) && $page_title == 'IT_ISSUEDETAIL' ? 'active' : '' ?>" href="<?= base_url('I_expansectl/i_expanseR') ?>">REPORT</a>
            <a class="dropdown-item <?= isset($page_title) && $page_title == 'IT_ISSUEDETAIL' ? 'active' : '' ?>" href="<?= base_url('I_expansectl/expansedatereport') ?>">DateReport</a>
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item <?= isset($page_title) && $page_title == 'IT_ISSUE' ? 'active' : '' ?>" href="<?= base_url('IT_issuectl/it_issuef') ?>">IT_ISSUE</a>
            <a class="dropdown-item <?= isset($page_title) && $page_title == 'IT_ISSUEDETAIL' ? 'active' : '' ?>" href="<?= base_url('IT_issuedetailctl/it_issuedf') ?>">ISSUE Detail</a>
            <a class="dropdown-item <?= isset($page_title) && $page_title == 'IT_PC' ? 'active' : '' ?>" href="<?= base_url('IT_pcctl/it_pcf') ?>">PC LIST</a>
            <a class="dropdown-item <?= isset($page_title) && $page_title == 'IT_BUY' ? 'active' : '' ?>" href="<?= base_url('IT_buyctl/it_buyf') ?>">BUY LIST</a>
